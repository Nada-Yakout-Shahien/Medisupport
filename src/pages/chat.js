  ...
  const sendMessage = (event) => {
    ...
    if (currentMessage.trim() !== "" || selectedFile) {
      ...
      setTimeout(() => {
        const doctorMessage = {
          id: Date.now(),
          text: doctorMessages[doctorMessageIndex],
          sender: "doctor",
        };
        setMessages((messages) => [doctorMessage, ...messages]);

        setDoctorMessageIndex(
          (prevIndex) => (prevIndex + 1) % doctorMessages.length
        );
      }, 2000);
    }
  };
        ...
        <div className="sidebarchat">
          ...
          <div className="sidebar">
            {doctorsData.map((doctor) => (
              <div key={doctor.id} className="doctorschat">
                <div className="slide">
        ...
        <div className="chatm">
          <div className="doctorinfor">
            <div className="contactimgchat">
              ...
              {doctorInfo.isOnline && <div className="onlineIndicator"></div>}
            </div>
            <div className="infor">
