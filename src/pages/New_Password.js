      ...
      <>
        ...
        <div className="new1">
          ...
          <label htmlFor="">Password</label>
                <input className="rnp" type="Password" id="password" placeholder="Your Password"/>
                <button id="btn" className="ttonr"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
